//
// Created by liuminzhe on 25-9-7.
//
#include <cmath>
#include <math.h>
#include <deque>
...
public:
    ...
    void UpdateXYZ_direct_give(double latitude, double longitude, double altitude);
...
void GnssProcess::UpdateXYZ_direct_give(double latitude, double longitude, double altitude) {
    //geo_converter.Forward(latitude, longitude, altitude, local_E, local_N, local_U);
    local_E = latitude;
    local_N = longitude;
    local_U = altitude;
